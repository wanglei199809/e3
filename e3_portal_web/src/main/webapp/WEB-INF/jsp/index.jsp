...
<div class="slide_show" id="slide_show">
	<div class="indexW">
	    ...
	    <div class="rSide">	
	    	<%-- <c:forEach items="${add2List}" var="node" varStatus="status">
	    		<a name="sfbest_hp_hp_focus_right-ad${status.index}" class="a-img r-img2 trackref" href="${node.url}" target="_blank">
					<img s="" alt="${node.title}" src="${node.pic}">
					<div class="rmask"></div>
				</a>
	    	</c:forEach> --%>
